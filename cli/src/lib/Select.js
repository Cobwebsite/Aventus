...
// import { flatMap, map, take, takeUntil, filter, share } from 'rxjs';
...
// 	// const Paginator = (await (eval('import("inquirer/lib/utils/paginator.js")'))).default;
// 	// const incrementListIndex = (await (eval('import("inquirer/lib/utils/incrementListIndex.js")'))).default;

// 	return class Select extends Base {
